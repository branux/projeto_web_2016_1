...
<html lang="pt-BR">
    ...
    <body>
        <form id="form_cadastro" name="form_cadastro" action="../../controller/Veiculos.php/insert" method="post">
            <label for="lbl_codigo">Código: </label>
            <input type="text" readonly id="ipt_codigo" name="ipt_codigo" disabled>
            <br/>
            ...
            <input type="number" id="ipt_ano" name="ipt_ano">
            <br>
            <label for="lbl_cor">Cor: </label>
            <input type="text" id="ipt_cor" name="ipt_cor">
            <br>
            <label for="lbl_placa">Placa: </label>
            <input type="text" id="ipt_placa" name="ipt_placa">
            <br>
            <label for="lbl_renavan">Renavan: </label>
            <input type="text" id="ipt_renavan" name="ipt_renavan">
            <br>
            <label for="lbl_chassi">Chassi: </label>
            <input type="text" id="ipt_chassi" name="ipt_chassi">
            <br>
